          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-navy-700">Call Now</h3>
                  <p className="text-gray-600">
                    <a href="tel:+61401540064" className="text-gold-500 hover:text-gold-600">
                      +61 401 540 064
                    </a>
                  </p>
                </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-navy-700">Email Address</h3>
                  <p className="text-gray-600">
                    <a
            ...
            {/* Social Links */}
            <div>
              <h3 className="font-semibold text-navy-700 mb-4">Connect</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  placeholder="Name"
                  required
                  className="w-full px-6 py-3 border-2 border-gray-200 rounded focus:outline-none focus:border-gold-500"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <input
                  ...
                  placeholder="Phone"
                  required
                  className="px-6 py-3 border-2 border-gray-200 rounded focus:outline-none focus:border-gold-500"
                />
                <input
                  type="email"
                  name="email"
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-navy-700 text-white font-semibold rounded hover:bg-navy-800 transition-colors disabled:opacity-50"
              >
