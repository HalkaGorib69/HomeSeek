      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={sectionRef}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <Card3D
              key={service.title}
              className="bg-white rounded-lg p-8 depth-2 hover:depth-4"
            >
              <div>
                ...
                <button className="w-full px-6 py-2 border-2 border-gold-500 text-gold-500 font-semibold rounded hover:bg-gold-50 transition-colors depth-1">
                  Read More
                </button>
              </div>
            </Card3D>
