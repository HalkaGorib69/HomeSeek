...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* Header Top - Dark Navy Background (hidden on mobile to avoid crowding) */}
      <div className="hidden md:block bg-navy-800 text-white py-3">
          ...
          <div className="flex justify-between items-center flex-wrap gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              <a href="mailto:sabi.hossan@homeseekadvisory.com.au" className="flex items-center gap-2 hover:text-gold-400 transition-colors">
                ...
                <span className="hidden lg:inline">sabi.hossan@homeseekadvisory.com.au</span>
              </a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pb-4 space-y-2 border-t">
              ...
              <div className="pt-2 mt-2 border-t space-y-2">
                <a
                  href="tel:+61401540064"
                  className="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-gray-50 rounded text-sm font-medium"
                  onClick={() => setMobileMenuOpen(false)}
                >
                ...
                >
                  ...
                  <span className="break-all">sabi.hossan@homeseekadvisory.com.au</span>
                </a>
              </div>
            </div>
          )}
